# backend/test/system/IPAROTestConstants.py
from system.IPARO import IPARO  # assumes system is in PYTHONPATH
...
iparo2 = IPARO(
    ...
    timestamp=time2,
    seq_num=1,
    linked_iparos=frozenset(),  # Fix this when IPAROLink is available
